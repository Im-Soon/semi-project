	...
	<div class="order-page-main">
		...
		<div class="order-content-main">
			...
			<form id="order_form" action="orderDetail.do" method="post">
				<ul>
					<li><label for="name">이름</label> <input type="text"
						name="name" id="name" maxlength="10"></li>
			...
			<table>
				...
				<tr>
					<td>cart에서 넘어온 제품1</td>
					<td>cart에서 넘어온 제품1</td>
					<td>cart에서 넘어온 제품1</td>
					<td>cart에서 넘어온 제품1</td>
				</tr>
				<tr>
					<td>cart에서 넘어온 제품2</td>
					<td>cart에서 넘어온 제품2</td>
					<td>cart에서 넘어온 제품2</td>
					<td>cart에서 넘어온 제품2</td>
				</tr>
			...
			<form id="order_form" action="orderDetail.do" method="post">
				<ul>
					<li>
						...
						<input type="radio" name="payment" value="1">무통장 입금
						<input type="radio" name="payment" value="2">카드 결제
						<div id="payment1">무통장</div>
						<div id="payment2">카드</div>
